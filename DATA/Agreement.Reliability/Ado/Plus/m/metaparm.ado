...
cap assert inlist("`dfcombine'","satterthwaite","constant");
if _rc!=0 {;
...
*
 ...
 and Satterthwaite denominators (if required)
*;
qui {;
...
*;
if "`tdist'"=="notdist" {;
  parmcip, estimate(`estimate') stderr(`stderr') `tdist' `eform' `options';

};
else {;
  parmcip, estimate(`estimate') stderr(`stderr') dof(`dof') `tdist' `eform' `options';
};
