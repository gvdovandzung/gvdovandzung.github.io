...
{p2colset 5 18 20 2}{...}
{p2col :{hi:iccvar} {hline 2}}intraclass correlation values and stadard errors for 2, 3, and 4 level models after {cmd:xtmixed}.{p_end}
{p2colreset}{...}
...
{pstd}{cmd:iccvar} is a post-estimation command for {cmd:xtmixed}.  After fitting a 2, 3, or 4 level model with a random intercept 
