! rii Version 1.0.1 bzelner@duke.edu & dan.blanchette@duke.edu  13Jul2009
...
quietly {
  ...
  label variable dYlb "Lower bound of 95% confidence interval for dY"
  label variable dYub "Upper bound of 95% confidence interval for dY"
 ...
 local quietly = "quietly"
  ...
  label variable Y0lb "Lower bound of `top'% confidence interval for Y0" 
  label variable Y0ub "Upper bound of `top'% confidence interval for Y0"
  label variable Y1lb "Lower bound of `top'% confidence interval for Y1"
  label variable Y1ub "Upper bound of `top'% confidence interval for Y1"
