...
{pstd}
{cmd:inputst} and {cmd:outputst} both use {help tempfile:temporary Stata datafiles}
...
{pstd}
and the {cmd:st} program of Stat/Transfer, in the user's system, has path {hi:"c:\Program Files\StatTransfer10\st.exe"},
...
{p 4 13 2}
{bind: }Manual: {hi:[P] macro}, {hi:[P] sysdir},{break}
