...
tab1 nhiemgiun,gen(giun)
tab1  nhomtuoi, gen(nt)


svyset [pweight = pwt], fpc(fpc) psu(a1)
svy linearized : proportion nhomtuoi a5 a4a a3a b1 a7 b5a 
svy linearized : proportion phandothieumau thieumau nhomferritin thieumauthieusat 


* So sanh nghe nghiep, giao duc, kinh te
xi: svy linearized : tab thieumau nhomtuoi, pearson col
xi: svy linearized : tab thieumau a5, pearson wald col
xi: svy linearized : tab thieumau a4a, pearson col
xi: svy linearized : tab thieumau a3a, pearson col
xi: svy linearized : tab thieumau b1, pearson col
xi: svy linearized : tab thieumau a7, pearson col
xi: svy linearized : tab thieumau b5a, pearson col

* So sanh cac yeu to b1 (so lan mang thai), b2 (so lan sinh con), b42(dieu hoa), b5(tuoithai)
xi: svy linearized : tab thieumau b1, pearson col
xi: svy linearized : tab thieumau b2, pearson col
xi: svy linearized : tab thieumau b42, pearson col
xi: svy linearized : tab thieumau b5, pearson col
* so sanh cac yeu to an uong tab1  c1 c21 c22 c23 c24 c25 - khong co y nghia c22
* Cac yeu to co anh huong la 

* di  an hai san-c22, rau dau-c23, trai cay-c24, tra caphe-c25
xi: svy linearized : tab thieumau c21, pearson col
xi: svy linearized : tab thieumau c22, pearson col 
xi: svy linearized : tab thieumau c23, pearson col
xi: svy linearized : tab thieumau c24, pearson col
xi: svy linearized : tab thieumau c25, pearson col

* Cac yeu to co anh huong la viensat-c4, chan dat-c1,tay giun-c5 khong anh huong
recode c4 1=1 else=0
xi: svy linearized : tab thieumau c4, pearson col
recode c1 0=0 1/2=1
xi: svy linearized : tab thieumau c1, pearson col
xi: svy linearized : tab thieumau c5, pearson col
...
xi: svy linearized : logistic thieumau nt1 nt3 i.a4a b5a c22 c23 c24 c4 c1 c5 giun2 giun3
